...
<head>
  ...
  <link rel="shortcut icon" href="../assets/icon_halaman.jpg" type="image/x-icon">
...
<body>
  <div class="clearfix">
    <nav class="navbar navbar-expand-lg p-2" aria-label="Thirteenth navbar example" style="background-color: #074799;">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
          <a class="navbar-brand col-lg-3 me-0" href="index.php" style="color: white; font-weight:bold; font-size:20px;"><span style="color:#A888B5;"><img src="../assets/logo.png" alt="Logo" style="width:50px; line-height:1;">Todo</span> List</a>
